...
{
  @Input() dataSource?: MatTableDataSource<Assignment>;
  ...
  @Output() pickupStatusChange = new EventEmitter<Assignment>();
  ...
  onPickupStatusChange(row: Assignment, value: PickupStatus) {
    this.pickupStatusChange.emit({ ...row, pickupStatus: value });
  }
